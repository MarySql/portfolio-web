(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const n of e)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function i(e){const n={};return e.integrity&&(n.integrity=e.integrity),e.referrerPolicy&&(n.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?n.credentials="include":e.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(e){if(e.ep)return;e.ep=!0;const n=i(e);fetch(e.href,n)}})();particlesJS("particles-js",{particles:{number:{value:150,density:{enable:!0,value_area:800}},color:{value:"#744f78"},shape:{type:"star",stroke:{width:0,color:"#fff"}},opacity:{value:.8,random:!0},size:{value:4,random:!0},line_linked:{enable:!1},move:{enable:!0,speed:1,direction:"bottom",random:!0,straight:!1,out_mode:"out",bounce:!1}},interactivity:{detect_on:"window",events:{onhover:{enable:!0,mode:"repulse"},onclick:{enable:!1}},modes:{repulse:{distance:80}}},retina_detect:!0});function m(){const t=document.createElement("header");t.className="py-3";const a=document.createElement("div");a.className="container d-flex justify-content-between align-items-center",a.innerHTML=`
 ...
 `,document.querySelector("#app").appendChild(t),g(),document.addEventListener("scroll",function(){document.querySelectorAll(".scroll-text").forEach(function(n){const o=n.getBoundingClientRect().top,r=window.innerHeight/1.5;o<r&&(n.style.animation="subtleScrollEffect 2s forwards ease-out")})})}function g(){const t=document.getElementById("skillsChart").getContext("2d");t.canvas.width=t.canvas.clientWidth,t.canvas.height=300,new Chart(t,{type:"bar",data:{labels:["React","Bootstrap","JavaScript","HTML/CSS","Sql"],datasets:[{label:"Skill levels",data:[40,60,70,90,45],backgroundColor:["rgba(75, 192, 192, 0.2)","rgba(153, 102, 255, 0.2)","rgba(255, 159, 64, 0.2)","rgba(54, 162, 235, 0.2)"],borderColor:["rgba(75, 192, 192, 1)","rgba(153, 102, 255, 1)","rgba(255, 159, 64, 1)","rgba(54, 162, 235, 1)"],borderWidth:1}]},options:{responsive:!0,maintainAspectRatio:!1,scales:{y:{beginAtZero:!0,max:100}}}})}function v(){const t=document.createElement("article");t.id="work";const a=`
  ...
  `,document.querySelector("#app").appendChild(t);const s=document.querySelector("#image-container .p-3"),e=document.createElement("img");e.src="assets/images/profile.svg",e.alt="Descrição da imagem",e.classList.add("img-fluid"),e.classList.add("contact-img"),s.appendChild(e)}m();u();p();v();f();
